(function() {
  App.Services.YouTubePlayer = (function() {
    function YouTubePlayer(videoURLs) {
      ...
      window.onYouTubePlayerReady = function(_) {
    ...
    YouTubePlayer.prototype.start = function() {
      ...
      return swfobject.embedSWF(this.buildYouTubeUrl(this.videoURLs[this.currentVideoIndex]), "player", "500", "400", "8", null, null, params, atts);
    };
