...
(function() {
  ...
  App.Views.PlaylistRowView = (function(_super) {
    ...
    PlaylistRowView.prototype.template = _.template("<div class='title'><strong><%= index %>.</strong> <span><%= title %></span><span class='genre'><%= genre %></span></div><div class='link' title='See in Reddit'>➜</div>");
    ...
    PlaylistRowView.prototype._playlistGenre = function() {
      var genre;
